...
export const speakers: Speaker[] = [
  {
    ...
    link: '',
    bio: {
      en: { text: '', link: 'http://www.marco.land' },
      de: { text: '', link: 'http://www.marco.land' },
    },
  },
  {
    editionNumber: 2,
  ...
  },
  {
    ...
    date: '2020-06-03',
    time: '22:00:00+02:00',
    image: 'img/nontsikelelo-mutiti/NM_Headshot2-1.jpg',
    caption: {
  ...
  },
  {
    ...
    date: '2020-06-17',
    time: '22:00:00+02:00',
    image: 'img/moniker/moniker-02.png',
    caption: {
    ...
    bio: {
      ...
      de: { text: '', link: 'https://studiomoniker.com/' },
    },
  },
  {
    editionNumber: 5,
    ...
    link: 'https://meet.jit.si/Jitsi-Bitsi-Spider',
    bio: {
      en: { text: '', link: 'https://www.s-marx.de/' },
      de: { text: '', link: 'https://www.s-marx.de/' },
    },
  },
  {
    editionNumber: 6,
    ...
    link: 'https://www.crowdcast.io/e/lecture-06--prem',
    bio: {
      en: {
        text: 'Partner and Director, Wkshps\nArtistic Director, FRONT International 2022\nOrganizer, Commune',
        link: ['http://wkshps.com/', 'http://2022.frontart.org/', 'https://docs.google.com/document/d/1Ri6_qgc7PfdeomBSOS1ElIHe09V8RoF9Cv7hMZZh_oM/edit'],
      },
      de: {
        text: 'Partner and Director, Wkshps\nArtistic Director, FRONT International 2022\nOrganizer, Commune',
        link: ['http://wkshps.com/', 'http://2022.frontart.org/', 'https://docs.google.com/document/d/1Ri6_qgc7PfdeomBSOS1ElIHe09V8RoF9Cv7hMZZh_oM/edit'],
  ...
  },
  {
    ...
    link: 'https://www.crowdcast.io/e/lecture-07--lukas',
    bio: {
      en: { text: '', link: 'https://www.studiolukasfeireiss.com/' },
      de: { text: '', link: 'https://www.studiolukasfeireiss.com/' },
    },
  },
  {
    editionNumber: 8,
  ...
  },
  {
    ...
    link: 'https://www.crowdcast.io/e/lecture-09--stefanie',
    bio: {
      en: { text: '', link: 'https://www.wunderlich-illustration.de/' },
      de: { text: '', link: 'https://www.wunderlich-illustration.de/' },
    },
  },
  {
    editionNumber: 10,
  ...
  },
  {
    ...
    time: '20:00:00+02:00',
    caption: {
      en: 'Berlin-based designer and educator Emily Smith will speak about expanded possibilities for contemporary design practice. Drawing from her own work and the work of others, she will present possible methods and processes from ethnographic, choreographic, and participatory creative fields.',
      de: '',
    },
    link: 'https://www.crowdcast.io/e/jitsi-bitsi-spider-11',
    bio: {
      en: { text: '', link: 'https://vimeo.com/422377009' },
      de: { text: '', link: '' },
    },
  },
  {
  ...
  },
  {
    ...
    link: 'https://www.crowdcast.io/e/jitsi-bitsi-spider-13',
    bio: {
      en: {
        text: 'Jan Wenzel is a publisher, author and artist living in Leipzig. Together with Markus Dreßen and Anne König he founded the publishing house Spector Books in 2001, which received the Saxon Publishing Prize in 2018 and the Deutsche Verlagspreis in 2019. Wolfgang Schwärzler is a graphic and type designer based in Leipzig, Germany.',
        link: '',
      },
      de: {
        text: 'Jan Wenzel lebt als Verleger, Autor und Künstler in Leipzig. Zusammen mit Markus Dreßen und Anne König hat er 2001 den Verlag Spector Books gegründet, der 2018 den Sächsischen Verlagspreis und 2019 den Deutschen Verlagspreis erhielt. Wolfgang Schwärzler ist ein Grafik- und Schriftdesigner aus Leipzig, Deutschland.',
        link: '',
      },
    },
  },
