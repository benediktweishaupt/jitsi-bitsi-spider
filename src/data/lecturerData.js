...
export const lecturerData = [
    {
        ...
        name: 'Marco Land',
        meetingRoomLink: '#',
        imageSrc: '', // Image source not provided
        captionText: {
            en: '', // English caption not provided
            de: 'Marco Land spricht über das Projekt: clubquarantaene.stream'
        },
        shortBio: {
            en: {
                text: '', // English bio not provided
                link: 'http://www.marco.land'
            },
            de: {
                text: '', // German bio not provided
                link: 'http://www.marco.land'
            }
        }
    },
    ...
    },
    {
        ...
        captionText: {
            ...
            de: '' // German caption not provided
        },
        shortBio: {
            en: {
                text: '', // English bio not provided
    ...
    },
    {
        ...
        name: 'Jan Wenzel (Spector Books) & Wolfgang Schwärzler (Camelot)',
